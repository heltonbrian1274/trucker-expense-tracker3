...
function resetAlreadySubscribedForm() {
    ...
    if (!formContainer) return; // Safety check
...
document.addEventListener('DOMContentLoaded', function () {
    // This is no longer needed with a modern service worker, but can be kept for safety
...
function updateTrialCountdown() {
    ...
    if (!trialElement || !textElement) return;
...
function updateSummary() {
    ...
    if (!dailyTotalEl || !totalExpensesEl) return;
